<template>
  <q-form @submit="onAddTransport" @reset="resetForm" class="col column justify-between" ref="form">
      ...
      <q-scroll-area class="col">
        <div class="column q-gutter-y-md">
          <q-input v-model="_type" type="text" borderless class="bg-grey-2 border-sm q-pl-md shadow-white-inset"
            hide-bottom-space hide-hint label-color="grey" label="Введите тип ТС" />
          <q-input v-model="_transportNumber" type="text" borderless
            ...
            label="Введите номер ТС" mask="A ### AA ###" />
          <q-select v-model="_place" type="text" borderless class="bg-grey-2 border-sm q-pl-md shadow-white-inset"
            ...
            :option-label="(item) => item.name" :option-value="(item) => item.id" clearable>
          ...
          <q-select v-model="_driver" type="text" borderless class="bg-grey-2 border-sm q-pl-md shadow-white-inset"
            hide-bottom-space hide-hint label-color="grey" label="Выберите водителя" :options="getFreeDrivers()" :option-label="
              (item) =>
